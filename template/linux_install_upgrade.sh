...
if [ "$device" != "duchamp" ]; then echo "Compatible devices: duchamp"; exit 1; fi
...
read -p "Enter 1 or 2: " root_choice
...
echo "Continue if you are upgrading from an older TengeOS ROM."
